package com.geekq.miaosha.init;
...
import com.geekq.miaosha.domain.ClusterGroupEntity;

import java.util.List;
import java.util.Objects;
import java.util.Optional;

import static com.geekq.miaosha.common.Constants.*;


/**
 * @author Eric Zhao
 * @Description: 集群限流的初始化类
 */
public class ClusterInitFunc implements InitFunc {

    //    private static final String APP_NAME = AppNameUtil.getAppName();
    private static final String APP_NAME = "auth";
    private static final String SEPARATOR = "@";
    //@Value("${sentinel.zookeeper.address}")
//    private static final String remoteAddress = "192.168.57.129:2181,192.168.57.129:2182,192.168.57.129:2183";
    private final String remoteAddress = "localhost";
    //    @Value("${sentinel.zookeeper.path}")
//    private static final String groupId = "sentinel_rule_config";
    ...
    private void initDynamicRuleProperty() {
        ReadableDataSource<String, List<FlowRule>> ruleSource = new NacosDataSource<>(remoteAddress, groupId, flowDataId,
